    ...
    async (worktreePath: string) => {
      ...
      try {
        ...
        if (result.success && result.result) {
          ...
          // hasRemoteTracking indicates if the branch has a remote tracking branch
          // If aheadCount or behindCount are present, we have remote tracking
          setHasRemoteTracking(
            result.result.aheadCount !== undefined || result.result.behindCount !== undefined
          );
